...
With the system we describe here, even though everyone can typically run any step of an analysis, they typically don't. This differs from a workflow tool where reproducibility
