...
src <- system.file("examples/simple", package = "orderly2", mustWork = TRUE)
...
which creates an orderly store with a file store and a complete tree. See `orderly2::orderly_init()` for more details.
